...
2. Checks whether the worker already exists on your account
...
You can deploy multiple Keyflare instances (e.g., for different environments or teams) using the `--name` flag:
